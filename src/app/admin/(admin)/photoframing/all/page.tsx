          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-1">
              ...
              <button
                ...
                className={`px-3 py-1 rounded-lg text-xs ${filter === "active"
                  ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-400"
                  : "bg-white/10 text-gray-600 dark:text-gray-400"
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1 rounded-lg text-xs ${filter === "inactive"
                  ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-400"
                  : "bg-white/10 text-gray-600 dark:text-gray-400"
                  }`}
              >
      ...
      {!isLoading && !error && filteredFrames.length > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredFrames.map((frame) => (
            <div
              key={frame._id}
              className={`bg-white/10 backdrop-blur-md rounded-xl border ${frame.isActive
                ? "border-white/20"
            ...
            >
              <div className="aspect-video relative bg-gray-100 dark:bg-gray-800 overflow-hidden">
                ...
                {frame.textSettings && frame.textSettings.length > 0 && (
                  <div
                    className="absolute bg-emerald-500/20 rounded px-2 py-1 text-xs pointer-events-none"
                    style={{
                      left: `${frame.textSettings[0].x}px`,
                      top: `${frame.textSettings[0].y}px`,
                      fontFamily: frame.textSettings[0].font,
                      fontSize: `${frame.textSettings[0].size}px`,
                      color: frame.textSettings[0].color,
                    }}
                  >
                    Name
                  </div>
              ...
              <div className="p-4">
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mb-4">
                  ...
                  <p>Texts: {frame.textSettings ? frame.textSettings.length : 0}</p>

                  {/* Add usage count display */}
                  <div className="flex items-center mt-2">
                    <div className={`flex items-center px-2 py-1 rounded ${(frame.usageCount || 0) > 0
                ...
                <div className="flex justify-between items-center">
                  <button
                    ...
                    className={`flex items-center px-3 py-1.5 rounded-lg text-sm transition-all duration-300 ${frame.isActive
