                ...
                <div className="p-6">
                    ...
                    <div className="flex justify-end space-x-4">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium shadow-lg flex items-center ${confirmText !== frame.name || isDeleting
